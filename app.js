...
const questionsDatabase = {
    "TOP 5": {
        3: [
            ...
            answers: [
               { "display": "Ζήσης Βρύζας (25 γκολ)", "synonyms": ["ζησησ βρυζας", "βρυζας", "vryzas", "zisis vryzas"] },
               { "display": "Τάσος Δουβίκας (16 γκολ)", "synonyms": ["τασοσ δουβικασ", "δουβικασ", "douvikas", "anastasios douvikas"] },
               { "display": "Παναγιώτης Κονέ (14 γκολ)", "synonyms": ["παναγιωτης κονε", "κονε", "kone", "panagiotis kone"] },
               { "display": "Κώστας Μανωλάς (9 γκολ)", "synonyms": ["κωστας μανωλας", "μανωλας", "manolas", "kostas manolas"] },
               { "display": "Γιώργος Καραγκούνης (8 γκολ)", "synonyms": ["γιωργοσ καραγκουνησ", "καραγκουνησ", "karagounis", "georgios karagounis"] }
            ]
        },
        { 
            id: 3, 
